...
if __name__ == '__main__':
    # for uncertainty, bounds in uncertainty_dict.items():
        ...
        model.outcomes = [
            ...
            ScalarOutcome("mean_inst_age"),
            ScalarOutcome("variance_inst_age"),
            ScalarOutcome("agents_avg_consumption"),
            ScalarOutcome("mean_in_degree"),
            ScalarOutcome("variance_in_degree"),
            ScalarOutcome("mean_comb_degree"),
            ScalarOutcome("variance_comb_degree"),
            ScalarOutcome("p_total_mean"),
            ScalarOutcome("p_total_variance"),
            ScalarOutcome("p_geo_mean"),
            ScalarOutcome("p_geo_variance"),
            ScalarOutcome("seed")
        ]
        ...
        with MultiprocessingEvaluator(model) as evaluator:
            ...
            experiments_df, outcomes_dict = evaluator.perform_experiments(scenarios=100)
            data[uncertainty] = experiments_df  
            for outcome in outcomes_dict.keys():
                data[uncertainty][outcome] = outcomes_dict[outcome]
            # save data frame
            file_path = "OFAT_weight_results/" + uncertainty + ".csv"
